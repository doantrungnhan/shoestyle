...
function binh_luan_rating(){
    $sql = "SELECT hh.ma_hh AS product_id, hh.ten_hh AS product_name, AVG(bl.rating) AS average_rating FROM hang_hoa hh LEFT JOIN binh_luan bl ON hh.ma_hh = bl.ma_hh GROUP BY hh.ma_hh, hh.ten_hh" ;
