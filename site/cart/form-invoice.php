...
<div class="row m-1 pb-5">
    <form action="<?= $SITE_URL . '/cart/invoice.php?add_dh' ?>" method="POST" class="col-6 m-auto" id="invoice"
        ...
        ?>
        <input type="hidden" name="tong_thanh_tien" class="tong_thanh_tien" value="<?=$totalAll?>">
