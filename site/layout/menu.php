<nav class="navbar navbar-md navbar-expand-lg navbar-dark p-1">
    <div class="container">
        <a class="navbar-brand" href="<?= $SITE_URL ?>/trang-chinh/index.php">
            <img class="img-fluid logo" src="<?= $CONTENT_URL ?>/images/Shoestyle-logo.ico" alt="logo">
        </a>
                ...
                <div class="dropdown widget-header icontext">
                    ...
                    <div class="text">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            ...
                            <a class="dropdown-item pl-3 py-2" 
                                href="<?= $SITE_URL . '/tai-khoan/doi-mk.php' ?>">Đổi mậtkhẩu</a>
                            <a class="dropdown-item pl-3 py-2" 
                                href="<?= $SITE_URL . '/cart/invoice.php' ?>">Đơn hàng của bạn</a>
                            <a class="dropdown-item pl-3 py-2"
